			...
			<tbody>
				<c:forEach items="${travelTripList}" var="tTrip">
					<tr>
                       ...
                       <td><a href="<c:url value="/${tTrip.id}/deleteTravelTrip.html"/>">delete</a></td>
                       <td><a href="<c:url value="/${tTrip.id}/editTravelTripForm.html"/>">edit</a></td>
                       <td><a href="<c:url value="/${tTrip.id}/detailsTravelTrip.html"/>">details</a></td>
                    </tr>
				</c:forEach>
			</tbody>
		</table>
...
<h4><a href="<c:url value="/addTravelTripForm.html"/>">Add New Travel Trip</a></h4>
</body>
</html>